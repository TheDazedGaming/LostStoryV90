...
function action(m,t,s) {
	...
	if (status == 0) {
		cm.sendNext("#eAh you saved me #r<3#k!");
	} else if (status == 1) {
		cm.sendNextNPC("#eThanks for saving my bitch... I mean, she's so stupid! She keep getting stuck. Alright let me warp you and give you your prize!", 5, 9201137);
	} else if (status == 2) {
		if (cm.getPlayer().getMapId() == 682000200) {
			...
			cm.sendOk("#eHey you little punk. No cheating. Do the jump quest...");
			cm.dispose();
		}
		cm.warp(100000000);
		cm.dispose();
