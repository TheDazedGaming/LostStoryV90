...
public class ServerConstants{
	...
	//
	public static String CENTER_SERVER_HOST = "127.0.0.1";
	public static final int CENTER_SERVER_PORT = 1111;
	public static String[] WORLD_SERVER_HOST = {"127.0.0.1"};
