...
public class MaplePacketCreator {
    ...
    public static final byte[] GainEXP_Monster(final int gain, final boolean white, final int partyinc, final int Class_Bonus_EXP, final int Equipment_Bonus_EXP, final int Premium_Bonus_EXP, final byte percentage, final double hoursFromLogin) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] spawnPlayerMapobject(MapleCharacter chr) {
        ...
        if (chr.getGuildId() <= 0) {
            ...
            System.out.println("YES. does it work?");
            if (gs != null) {
                ...
                System.out.println("loaded guild");
            } else {
                mplew.writeInt(0);
                mplew.writeInt(0);
            }
...
//	mplew.write((slot2 > 0 ? 1 : 0) + 1);
    ...
    public static final byte[] charInfo(final MapleCharacter chr, final boolean isSelf) {
        ...
        for (final MaplePet pet : chr.getPets()) {
            if (pet.getSummoned()) {
                mplew.write(pet.getUniqueId()); //o-o byte ? index i guess
    ...
    public static byte[] stopClock() {
        return getPacketFromHexString("9E 00"); //does the header not work?
    }
...
//    public static MaplePacket onMessage_(final byte type) {
//        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
//
//        mplew.writeShort(SendPacketOpcode.SHOW_STATUS_INFO.getValue());
//        mplew.write(type);
//        switch (type) {
//            case 0: { // OnDropPickUpMessage
//                mplew.write(action);
//                // -2: This item is unavailable for pickup.
//                // -3: You cannot acquire any items because the game file has been damaged. please try again after reinstalling the game.
//                // default: You can't get anymore items.
//                if (action == 0) {
//                    mplew.writeInt(0); // item id
//                    mplew.writeInt(0); // quantitiy
//                    // Quantity <= 1 : You have gained an item in the Eqp tab (<item name>)
//                    // Else : You have gained items in the Eqp tab (<item name>)
//                } else if (action == 1) {
//                    mplew.write(0); // 0x01 : A portion was not found after falling on the ground.
//                    mplew.writeInt(0); // Mesos
//                    mplew.writeShort(0); // Internet Cafe Meso Bonus
//                } else if (action == 2) { // Monster Card
...
//                break;
//            }
//            case 3: { // OnIncEXPMessage
//                mplew.write(0); // white = 1, yellow = 0
//                mplew.writeInt(0); // amount
//                mplew.write(inChat);
//                mplew.writeInt(0); // Bonus Event EXP
//                mplew.write(percentage);
//                mplew.write(0);
...
//                break;
//            }
//            case 4: { // OnIncSPMessage
//                mplew.writeShort(job);
//                mplew.write(sp);
//                break;
//            }
//            case 5: { // OnIncPOPMessage
//                // You have gained/lost fame. (+/-<fame>)
//                mplew.writeInt(fame);
//                break;
//            }
//            case 6: { // OnIncMoneyMessage
//                // You have gained/lost mesos. (+/-<mesos>)
//                mplew.writeInt(mesos);
//                break;
//            }
//            case 7: { // OnIncGPMessage
//                // You have earned/lost Guild Points. (+/-<points>)
//                mplew.writeInt(points);
//                break;
//            }
//            case 8: { // OnGiveBuffMessage
//                // Will show the description of the item (buff item)
//                mplew.writeInt(0); // buff item id?, eg: 2022436
//                break;
//            }
//            case 9: { // OnGeneralItemExpireMessage
//                // The item [<Item Name>] has expired, and therefore, deleted from your inventory.
//                mplew.write(item.size()); // Size
//                for (Integer it : item) {
//                    mplew.writeInt(it);
//                }
//                break;
//            }
//            case 10: { // OnSystemMessage
//                // Shows a red message only.
//                mplew.writeMapleAsciiString(message);
//                break;
//            }
//            case 11: { // OnQuestRecordExMessage
//                // This just update the data in the "PacketHelper.getCharacterInfo"
//                mplew.writeShort(quest);
//                mplew.writeMapleAsciiString(data);
//                break;
//            }
...
//            }
//            case 13: { // OnItemExpireReplaceMessage
//                // Basically shows a red message only.
//                mplew.write(message.size()); // Size
