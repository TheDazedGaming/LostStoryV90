...
public class MobHandler {
        ...
        if (res != null && chr != null && res.size() > 0) {
            ...
            map.broadcastMessage(chr, MobPacket.moveMonster(useSkill, skill, skill1, skill2, skill3, skill4, monster.getObjectId(), startPos, res), endPos);
    ...
    public static final void SelfDestruct(final int oid, final MapleCharacter chr) {
        final MapleMonster monster = chr.getMap().getMonsterByOid(oid);
    ...
    public static final void MonsterBomb(final SeekableLittleEndianAccessor slea, final MapleCharacter chr, final MapleClient c) {
        ...
        if (skill != null /*&& monster.getBuff(MonsterStatus.MONSTER_BOMB) != null*/) {
            c.getSession().write(MaplePacketCreator.showMonsterBombEffect(xpos, ypos, chr.getSkillLevel(skill)));
