...
public class NPCConversationManager extends AbstractPlayerInteraction {
  ...
  //  private MapleCharacter player = c.getPlayer();
...
public void sendNextNPC(String text, byte type, int OtherNPC) {
    ...
    public void sendAcceptDeclineNoESC(String text) { // doesn't work..let it fallback..
        askAcceptDecline(text);
    }
    ...
    if (theSkill != null) {
    return c.getPlayer().isSkillBelongToJob(skillid);
    ...
    public final int getKegs() {
        return AramiaFireWorks.getInstance().getKegsAmount();
    }
    ...
    public final int getRequiredKegs() {
        return AramiaFireWorks.getInstance().getKegs();
    }
    ...
    public final void maxAllSkills() {
        for (ISkill skil : SkillFactory.getAllSkills()) {
            if (GameConstants.isApplicableSkill(skil.getId())) { //no db/additionals/resistance skills
                if (skil.getId() >= 22000000 && (GameConstants.isEvan((skil.getId() / 10000)) || GameConstants.isResist((skil.getId() / 10000)))) {
                    continue;
                } // only beginner skills are not maxed!
                if (skil.getId() < 10000 || ((skil.getId() / 10000) == 1000) || ((skil.getId() / 10000) == 2000) || ((skil.getId() / 10000) == 2001)) {
        ...
        CloneTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                if (chr == null || getPlayer() == null) {
                    ...
                    sendNPCText(getPlayer().getName() + " and " + chr.getName() + ", I wish you two all the best on your journey together!", 9201002);
    ...
    public String populateKeymapValues() {
        ...
        StringBuilder sb = new StringBuilder("Which of the skills would you like to keep? Please note that you can only select the skills which are on your keymap.\r\n");
        ...
        while (itr.hasNext()) {
            ...
            if (key.getLeft() == 1 && key.getRight() <= 0) {
                if (!JobConstants.isEvanSkill(key.getMid())) { // not evan skills
                    if (key.getMid() >= 30000000 || key.getMid() == 1004 || key.getMid() == 10001004 || key.getMid() == 20001004 || key.getMid() == 20011004) {
                        continue;
                    }
                    if (((key.getMid() / 10000 == 910) || (key.getMid() / 10000 == 900)) && !c.getPlayer().isGM()) {  // is gm skills but person not gm
                        continue;
                    }
                    if (GameConstants.getMountItem(key.getMid()) != 0 && key.getMid() != 5221006) { // special mounts and skill is not battleship
                        continue;
                    }
                    sel++;
   ...
   public void setVPoints(int amnt) {
    ...
    public String getJobName(short jobid) {
        switch (jobid) {
            ...
            case 320 : return "Sniper";
            case 321 : return "Crossbow Master";
            ...
            case 512 : return "Buccaner";
            case 522 : return "Corsair";
            case 1000 : return "Noblesse";
            case 1100 : return "Dawn Warrior Job 1";
            case 1110 : return "Dawn Warrior Job 2";
            case 1111 : return "Dawn Warrior Job 3";
            case 1112 : return "Dawn Warrior Job 4";
            case 1200 : return "Blaze Wizard Job 1";
            case 1210 : return "Blaze Wizard Job 2";
            case 1211 : return "Blaze Wizard Job 3";
            case 1212 : return "Blaze Wizard Job 4";
            case 1300 : return "Wind Archer Job 1";
            case 1310 : return "Wind Archer Job 2";
            case 1311 : return "Wind Archer Job 3";
            case 1312 : return "Wind Archer Job 4";
            case 1400 : return "Night Walker Job 1";
            case 1410 : return "Night Walker Job 2";
            case 1411 : return "Night Walker Job 3";
            case 1412 : return "Night Walker Job 4";
            case 1500 : return "Thunder Breaker Job 1";
            case 1510 : return "Thunder breaker Job 2";
            case 1511 : return "Thunder Breaker Job 3";
            case 1512 : return "Thunder Breaker Job 4";
            case 2000 : return "Legend";
            case 2100 : return "Aran Job 1";
            case 2110 : return "Aran Job 2";
            case 2111 : return "Aran Job 3";
            case 2112 : return "Aran Job 4";
            case 2200 : return "Evan Job 1";
            case 2210 : return "Evan Job 2";
            case 2211 : return "Evan Job 3";
            case 2212 : return "Evan Job 4";
            case 2213 : return "Evan Job 5";
            case 2214 : return "Evan Job 6";
            case 2215 : return "Evan Job 7";
            case 2216 : return "Evan Job 8";
            case 2217 : return "Evan Job 9";
            case 2218 : return "Evan Job 10";
        }
    ...
    //faction related
    /*
    public void addPlayerToFaction(byte factionid) {
           //if (getPlayer().getFactionId() == 0) {
            World.getFaction(factionid).addMember(getPlayer());
         //sendOk("You have been added to the " + World.getFaction(factionid).getNameByType());
        //} else {
       //sendOk("You are already in a faction, why would you leave them?!");
      //}
     //dispose();   
    }
    
    public void gainFactionPoints(int amount) {
        World.getFaction(getPlayer().getFactionId()).updatePoints(amount);
        getPlayer().updateContributedFP(amount);
    }
    
    public byte getPlayerFaction() {
        return getPlayer().getFactionId();
    }
    
    public String getFactionTeamString() {
       return World.getFaction(getPlayer().getFactionId()).getNameByType();
    }*/
    ...
    public String ranking(byte type) {
        Connection con = DatabaseConnection.getConnection();
        try {
            PreparedStatement ps = con.prepareStatement("SELECT name, reborns, jumplevel, jumpxp FROM tropik90");
            ResultSet rs = ps.executeQuery();
            switch(type) {
                case 1:
                    return ""+rs+"";
    ...
    public String getDailyMissionInfo(int id) {
        switch(id) {
            case 160000: return "Kill 1000 cows";
            case 160001: return "Kill 1000 roosters";
            case 160002: return "Kill 500 cows";
            case 160003: return "Kill 500 roosters";
            case 160004: return "Kill 200 Ninja from Ninja 1 map";
            case 160005: return "Kill 500 Ninja from Ninja 1 map";
            case 160006: return "Hunt 100 oranges mushroom caps";
            default:
    ...
    //factions
    public void gainFactionPoints(int val) {
        getPlayer().gainFactionPoints(val);
    }
    ...
    public String generateFactionRanking() {
        final StringBuilder sb = new StringBuilder("Rank ");
        int rank = 0;
        try {
            Connection con = DatabaseConnection.getConnection();
            PreparedStatement ps = con.prepareStatement("SELECT * FROM faction ORDER BY points DESC");
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                rank++;
                sb.append(rank).append(" - ").append(World.Faction.getFactionById(rs.getInt("id")).getName()).append(" with ").append(rs.getInt("points")).append(" points ");
            }       
        }catch(SQLException e) {
            System.out.println(e);
        }
