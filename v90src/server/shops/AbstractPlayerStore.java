...
public abstract class AbstractPlayerStore extends AbstractMapleMapObject implements IMaplePlayerShop {
    ...
    protected AtomicInteger coconut = new AtomicInteger(0);
    ...
    @Override
    public short getCoconut() {
        return (short)coconut.get();
    }

    @Override
    public void setCoconut(short coconut) {
        this.coconut.set(coconut);
    }
