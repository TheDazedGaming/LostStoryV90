        ...
        try {
            for (Entry<String, Integer> stat : sta.entrySet()) {
                if (stat.getKey().equals("STRMin")) {
                    nEquip.setStr((short) (Math.max(nEquip.getStr() + rand(stat.getValue().intValue(), sta.get("STRMax").intValue()), 32767)));
                } else if (stat.getKey().equals("DEXMin")) {
                    nEquip.setDex((short) (Math.max(nEquip.getDex() + rand(stat.getValue().intValue(), sta.get("DEXMax").intValue()), 32767)));
                } else if (stat.getKey().equals("INTMin")) {
                    nEquip.setInt((short) (Math.max(nEquip.getInt() + rand(stat.getValue().intValue(), sta.get("INTMax").intValue()), 32767)));
                } else if (stat.getKey().equals("LUKMin")) {
                    nEquip.setLuk((short) (Math.max(nEquip.getLuk() + rand(stat.getValue().intValue(), sta.get("LUKMax").intValue()), 32767)));
                } else if (stat.getKey().equals("PADMin")) {
                    nEquip.setWatk((short) (Math.max(nEquip.getWatk() + rand(stat.getValue().intValue(), sta.get("PADMax").intValue()), 32767)));
                } else if (stat.getKey().equals("PDDMin")) {
                    nEquip.setWdef((short) (Math.max(nEquip.getWdef() + rand(stat.getValue().intValue(), sta.get("PDDMax").intValue()), 32767)));
                } else if (stat.getKey().equals("MADMin")) {
                    nEquip.setMatk((short) (Math.max(nEquip.getMatk() + rand(stat.getValue().intValue(), sta.get("MADMax").intValue()), 32767)));
                } else if (stat.getKey().equals("MDDMin")) {
                    nEquip.setMdef((short) (Math.max(nEquip.getMdef() + rand(stat.getValue().intValue(), sta.get("MDDMax").intValue()), 32767)));
                } else if (stat.getKey().equals("ACCMin")) {
                    nEquip.setAcc((short) (Math.max(nEquip.getAcc() + rand(stat.getValue().intValue(), sta.get("ACCMax").intValue()), 32767)));
                } else if (stat.getKey().equals("EVAMin")) {
                    nEquip.setAvoid((short) (Math.max(nEquip.getAvoid() + rand(stat.getValue().intValue(), sta.get("EVAMax").intValue()), 32767)));
                } else if (stat.getKey().equals("SpeedMin")) {
                    nEquip.setSpeed((short) (Math.max(nEquip.getSpeed() + rand(stat.getValue().intValue(), sta.get("SpeedMax").intValue()), 32767)));
                } else if (stat.getKey().equals("JumpMin")) {
                    nEquip.setJump((short) (Math.max(nEquip.getJump() + rand(stat.getValue().intValue(), sta.get("JumpMax").intValue()), 32767)));
                } else if (stat.getKey().equals("MHPMin")) {
                    nEquip.setHp((short) (Math.max(nEquip.getHp() + rand(stat.getValue().intValue(), sta.get("MHPMax").intValue()), 32767)));
                } else if (stat.getKey().equals("MMPMin")) {
                    nEquip.setMp((short) (Math.max(nEquip.getMp() + rand(stat.getValue().intValue(), sta.get("MMPMax").intValue()), 32767)));
                } else if (stat.getKey().equals("MaxHPMin")) {
                    nEquip.setHp((short) (Math.max(nEquip.getHp() + rand(stat.getValue().intValue(), sta.get("MaxHPMax").intValue()), 32767)));
                } else if (stat.getKey().equals("MaxMPMin")) {
                    nEquip.setMp((short) (Math.max(nEquip.getMp() + rand(stat.getValue().intValue(), sta.get("MaxMPMax").intValue()), 32767)));
                }
            }
