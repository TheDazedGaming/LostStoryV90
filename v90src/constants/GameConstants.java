...
public class GameConstants {
    ...
    public static final String[] RESERVED = {"Tropik"};
    ...
    public static short EntrustedStoreTax(final short coco) {
        if (coco >= 50) {
            return (short)Math.round(0.03 * coco);
        } else if (coco >= 100) {
            return (short) Math.round(0.025 * coco);
        } else if (coco >= 400) {
            return (short) Math.round(0.02 * coco);
        } else if (coco >= 700) {
            return (short) Math.round(0.015 * coco);
        } else if (coco >= 1200) {
            return (short) Math.round(0.009 * coco);
        } else if (coco >= 2000) {
            return (short) Math.round(0.004 * coco);
        }
        return 0;
    }
